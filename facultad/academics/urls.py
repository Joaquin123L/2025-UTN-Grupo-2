...
urlpatterns = [
    ...
    path("evaluar/<int:mca_id>/editar/", views.editar_resena_mca, name="editar_resena_mca"),
    path("evaluar/<int:mca_id>/eliminar/", views.eliminar_resena_mca, name="eliminar_resena_mca"),
